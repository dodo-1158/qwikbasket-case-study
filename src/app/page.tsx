...
//                 produce on flexible credit—without the anxiety of &quot;udhaari&quot;chaos.
//               </p>
...
export default function Home() {
  ...
  return (
    <main className={styles.page}>
      ...
      {/* User Research & Persona - ENHANCED */}
      <section id="user" className={styles.section}>
        <SectionHeader
          eyebrow="Understanding the User"
          title="Who We Designed Qwikbasket For"
        ...
        <div className={styles.twoColumn}>
          ...
          <div className={styles.column}>
            ...
            <div className={styles.personaGrid}>
              ...
              <div className={styles.personaTile}>
                <p className={styles.personaLabel}>Daily Routine</p>
                <p className={styles.personaMeta}>
                  Starts day at 5am, checks supplies, orders by 6am. Juggles kitchen prep, staff briefings, and vendor calls until lunch rush at noon.
                </p>
              </div>

              <div className={styles.personaTile}>
                <p className={styles.personaLabel}>Tech Stack</p>
                <p className={styles.personaMeta}>
                  Uses WhatsApp for vendor orders, Swiggy for customer orders, basic Excel for monthly accounting. Comfortable with mobile apps.
                </p>
              </div>
              ...
              <div className={styles.personaTile}>
                <p className={styles.personaLabel}>Pain Severity</p>
                <p className={styles.personaMeta}>
                  Spends 45 min/day managing vendor payments, tracking dues, and resolving payment disputes—time better spent on customers.
                </p>
              </div>
      ...
      {/* User Journey Map - ENHANCED WITH EMOTIONAL ARC */}
      <section id="journey" className={styles.section}>
        <SectionHeader
          eyebrow="End-to-End Flow"
          title="User Journey: From Bulk Ordering to Smart Credit"
          ...
          <div className={styles.journeyTableWrapper}>
            <table className={styles.journeyTable}>
              ...
              <tbody>
                ...
                <tr className={styles.emotionalRow}>
                  <td className={styles.journeyLabel}>Emotional Arc</td>
                  <td>😐 Neutral → 🤔 Curious</td>
                  <td>😊 Confident → ✅ In Control</td>
                  <td>😌 Relieved → 😟 Slightly Anxious</td>
                  <td>😌 Calm → ✨ Informed</td>
                </tr>
                <tr>
                  <td className={styles.journeyLabel}>Feeling</td>
                ...
                <tr className={styles.painPointRow}>
                  <td className={styles.journeyLabel}>Pain Points</td>
                  <td>
                    Overwhelmed if catalog is cluttered; distrust of unknown suppliers.
                  </td>
                ...
                <tr className={styles.opportunityRow}>
                  <td className={styles.journeyLabel}>Qwikbasket UX Opportunities</td>
                  <td>
                    Clean category cards with photos, clear unit pricing, supplier badges.
                  </td>
      ...
      <section id="design" className={styles.section}>
        ...
        <div className={styles.designSystemContainer}>
          ...
          <p className={styles.sectionIntro}>
            A systematic approach to colors, typography, and UI components ensuring consistency across the entire product.
          </p>
          <img
            src="/design-system.png"
           
            alt="Design System - Colors and Typography"
